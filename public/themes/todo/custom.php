 ...
 *
 * Class contains the rules and methods called for the Locker site template
 */
...
class Todo {
    ...
    private function _getPageHTML( $data ) {
        ...
        if ( $this->settings['_logged_in'] === false ) { $defaultPage = 'login'; }

        // Which Page Should be Returned?
        $ReqPage = 'page-' . NoNull($defaultPage, NoNull($this->settings['PgRoot'], 'main')) . '.html';
        ...
        $ReplStr = array( '[HOMEURL]'      => NoNull($this->settings['HomeURL']),
                          '[FONT_DIR]'     => $SiteUrl . '/themes/' . $data['location'] . '/fonts',
                          '[CSS_DIR]'      => $SiteUrl . '/themes/' . $data['location'] . '/css',
                          '[IMG_DIR]'      => $SiteUrl . '/themes/' . $data['location'] . '/img',
                          '[JS_DIR]'       => $SiteUrl . '/themes/' . $data['location'] . '/js',
                          '[CSS_VER]'      => CSS_VER,
                          ...
                          '[AVATAR_IMG]'    => $SiteUrl . '/avatars/' . NoNull($this->settings['_avatar_file'], 'default.png'),
